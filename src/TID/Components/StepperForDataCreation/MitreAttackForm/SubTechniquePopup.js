...
const SubTechniquePopup = ({ data, usage, handleSelection, handleDeSelection, isSelected }) => {
    ...
    return (
        <>
            <div onClick={handleOpen}>
                <div
                    className="sub_tech_child"
                    style={{
                        backgroundColor: selectedSubTech ? BackgroundColor : "",
                        color:
                            selectedSubTech && BackgroundColor !== ColorOptions.YELLOW
                                ? TextColor.WHITE
                                : "var(--name-email)",
                    }}
                >
            ...
            >
                <DialogTitle className="header">
                    ...
                    <p style={{ fontSize: "medium", fontWeight: "initial" }}>
                        Provide details of the usage of this Sub Technique
                    </p>
                </DialogTitle>
...
export default SubTechniquePopup;
